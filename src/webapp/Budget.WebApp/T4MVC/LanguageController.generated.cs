...
namespace Budget.WebApp.Controllers
{
    public partial class LanguageController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public LanguageController Actions { get { return MVC.Language; } }
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_LanguageController : Budget.WebApp.Controllers.LanguageController
    {
        public T4MVC_LanguageController() : base(Dummy.Instance) { }

        [NonAction]
        partial void ChangeOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string id);

        [NonAction]
        public override System.Web.Mvc.ActionResult Change(string id)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Change);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "id", id);
            ChangeOverride(callInfo, id);
            return callInfo;
        }
