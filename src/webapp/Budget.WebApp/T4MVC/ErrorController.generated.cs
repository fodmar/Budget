...
namespace Budget.WebApp.Controllers
{
    public partial class ErrorController
    {
        ...
        public class ViewsClass
        {
            ...
            {
                public readonly string _LayoutError = "_LayoutError";
                public readonly string BadRequest = "BadRequest";
                public readonly string Error = "Error";
                public readonly string Forbidden = "Forbidden";
                public readonly string NotFound = "NotFound";
            }
            public readonly string _LayoutError = "~/Views/Error/_LayoutError.cshtml";
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ErrorController : Budget.WebApp.Controllers.ErrorController
    {
